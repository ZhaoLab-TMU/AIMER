...
The output file of this step contains the information of the sequences from the two groups, the columns included in the output file refer to the description of the file ./examples/test.AIMER.bin.bed in [File description](https://github.com/ZhaoLab-TMU/AIMER/tree/main?tab=readme-ov-file#file-descriptionsee-examples)
